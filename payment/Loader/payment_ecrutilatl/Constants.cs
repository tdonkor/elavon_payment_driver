...
namespace Acrelec.Mockingbird.Payment
{
    ...
    {
        public const string ID = "826010";

        public const string PAYMENT_NAME = "UK_ELAVON_ECRUTILATL";

        public const string PAYMENT_APPLICATION_PROCESS_NAME = "PAY_UK_ELAVON_ECRUTILATL";
